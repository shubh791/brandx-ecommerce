...
/* =========================================================
   TOP ROW FASHION GARMENTS (BALANCED 4-COLUMN HORIZONTAL SPREAD)
   ========================================================= */

/* 1. Black Tee (Top-Left of the right visual zone) */
.blackTee {
  top: 2%;
  left: 0%;
  z-index: 6;
...
/* 2. Cream Tee (Top-Middle-Left with clear spacing from black tee) */
.creamTee {
  top: 0%;
  left: 28%;
  z-index: 3;
...
/* 3. Black/Grey Denim Jeans (Placed in between Cream Tee and Blue Jeans) */
.denim {
  top: 4%;
  left: 52%;
  z-index: 4;
...
/* 4. Indigo Blue Denim (Top-Right with clean spacing from black jeans) */
.blueDenim {
  top: 6%;
  right: -2%;
  z-index: 5;
...
/* 6. Black Streetwear Runner (Bottom-Center between bag and white sneaker) */
.blackSneaker {
  bottom: 6%;
  left: 30%;
  z-index: 8;
...
console.log('HeroBanner layout updated with balanced spacing and black jeans in-between!');
