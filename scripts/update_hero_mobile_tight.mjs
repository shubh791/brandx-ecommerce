...
/* =========================================================
   RESPONSIVE BREAKPOINTS (TIGHT & BALANCED ACROSS ALL MOBILES)
   ========================================================= */
...
@media (max-width: 600px) {
  ...
  /* Compact, tight, fully-contained mobile visual composition */
  .visual {
    width: 100%;
    max-width: 22rem;
    height: 280px;
  ...
  /* Bottom Row (Pulled tightly directly under the X) */
  .bag {
    display: block;
    left: 1%;
    bottom: 2%;
...
console.log('HeroBanner.module.css updated with tight mobile layout and zero vertical gap!');
