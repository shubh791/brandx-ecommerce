...
const wishlistDrawerJsx = `'use client';
...
fs.writeFileSync('components/layout/WishlistDrawer.jsx', wishlistDrawerJsx, 'utf-8');
console.log('WishlistDrawer updated successfully!');
